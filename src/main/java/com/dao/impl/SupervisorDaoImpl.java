...
public class SupervisorDaoImpl implements SupervisorDao {
	...
	@Override
	@SuppressWarnings("unchecked")
	public List<ProductBean> findprobybid(int brandId) {
		Session session = factory.getCurrentSession();
		String hql = "From ProductBean where brandBean.BrandID = :bid";
	    List<ProductBean> pblist = (List<ProductBean>) session.createQuery(hql).setParameter("bid", brandId).getSingleResult();
		return pblist;
	}
