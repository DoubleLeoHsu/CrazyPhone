...
//	}
	...
	public String addToCart(Model model, @RequestParam Integer phoneId, @RequestParam String phoneName,
			@RequestParam Integer phonePrice, @RequestParam Integer qty, @RequestParam String page) {
	...
	public String addToCart_products(Model model, @RequestParam Integer phoneId, @RequestParam String phoneName,
			@RequestParam Integer phonePrice, @RequestParam Integer qty, @RequestParam String page) {
	...
	public String addToCart_index(Model model, @RequestParam Integer phoneId, @RequestParam String phoneName,
			@RequestParam Integer phonePrice, @RequestParam Integer qty, @RequestParam String page) {
	...
	public String addQtyToCart(Model model, @RequestParam Integer phoneId, @RequestParam String phoneName,
			@RequestParam Integer phonePrice, @RequestParam Integer qty, @RequestParam String page) {
	...
	public String DelQtyToCart(Model model, @RequestParam Integer phoneId, @RequestParam String phoneName,
			@RequestParam Integer phonePrice, @RequestParam Integer qty, @RequestParam String page) {
	...
	public String DelProductToCart(Model model, @RequestParam Integer phoneId, @RequestParam String page) {
	...
	public String orderToDB(Model model, SessionStatus status, @RequestParam Integer MemberID,
			@RequestParam String Receiver, @RequestParam String ReceiverPhone, @RequestParam String ShipAddress,
			@RequestParam String page, @RequestParam Integer productID, @RequestParam String productName,
			@RequestParam Integer unitPrice, @RequestParam(value = "quantity") Integer quantity,
			@RequestParam(value = "total") Integer sum1, @RequestParam(value = "product") String product,
		...
		System.out.println("Log in 2>" + OrderID + ">>" + MemberID + ">>" + OrderDate + ">>" + ShipAddress + ">>"
				+ Receiver + ">>" + ReceiverPhone);
		OrdersBean ob = new OrdersBean(null, OrderID, MemberID, OrderDate, productID, productName, quantity, null, sum1,
				null, null, ShipAddress, Receiver, ReceiverPhone, null);
