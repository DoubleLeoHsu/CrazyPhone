...
public class SupervisorController {
	...
	@GetMapping("/find")
	public ResponseEntity<List<ProductBean>> find (int brandid){
		List<ProductBean> resulp = (List<ProductBean>) supervisorervice.getproductbyid(brandid);
		@SuppressWarnings("rawtypes")
		ResponseEntity<List<ProductBean>> listsucsess = new ResponseEntity(resulp, HttpStatus.OK);
		return listsucsess;
	}
